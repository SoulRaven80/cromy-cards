...
public class CromyDeck {
    ...
    private static void addCard(double height, double weight, int strength, int speed, double transformation, String id, String name) {
        ...
        stats.add(CromyStat.builder().statName(CromyStat.StatName.HEIGHT).value(height).build());
        stats.add(CromyStat.builder().statName(CromyStat.StatName.WEIGHT).value(weight).build());
        stats.add(CromyStat.builder().statName(CromyStat.StatName.STRENGTH).value(strength).build());
        stats.add(CromyStat.builder().statName(CromyStat.StatName.SPEED).value(speed).build());
        stats.add(CromyStat.builder().statName(CromyStat.StatName.TRANSFORMATION_SPEED).value(transformation).build());
        cards.add(CromyCard.builder().id(id).name(name).stats(stats).build());
    }
}
